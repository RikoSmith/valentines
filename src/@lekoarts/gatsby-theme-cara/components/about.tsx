      ...
      <Inner>
        <div className='about-container'>
          ...
          <ul>
            ...
            <li>Step 4: Get the link to a Singing Valentine with your chosen song (Note: the song will appear only from 14th of February)</li>
            <li>Step 5: Send the link to the recipient (Note: the link should be the one generated by the website)</li>
            <li>Step 6 (optional): In case you want to stay anonymous, fill in this <a href="https://forms.gle/vLk9xf4ppq4hf1vW6">google form</a></li>
